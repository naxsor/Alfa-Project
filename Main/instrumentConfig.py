...
class instrumentConfig:
    ...
    def WIBS_NEO(self):
        ...
        insttrumentFile_Format = '.h5'
        instrumentMonitoringData = ('Board_1', 'Bandwidths_0', 'Bandwidths_1', 'Bandwidths_2', 'Bandwidths_3', 'Baseline_0', 'Baseline_1', 'Baseline_2', 'Baseline_3', 'Clump_Cound', 'conc_excited_cm3', 'conc_total_cm3', 'H12310 Temperature', 'Max_Transit_Time_counts', 'Min_Transit_Time_counts', 'Missed_Particle_Count', 'Num_Discarted_Particles', 'Num_Oversize_Rejects', 'RH', 'SYS_V', 'Sample_MassFlow', 'Sample_PSIA', 'Sample_Temperature', 'Sample_VolumetricFlowRate', 'Seconds', 'Sheath_MassFlow', 'Sheath_PSIA', 'Sheath_SetPoint', 'Sheath_Temperature', 'Sheath_VolumetricFlowRate', 'Sizer_Oversize_Count', 'Temperature', 'Total_Particle_Count', 'Total_Trigger_Count', 'Valid_Particle_Count', 'XE1_Power', 'XE1_Power')
        instrumentParticleData = ('Asphericity', 'Density', 'EP_Overflow_Flag', 'Flag_Excited', 'Mass_ug', 'NF_Shape_0', 'NF_Shape_1', 'NF_Shape_2', 'NF_Shape_3', 'NF_Sizer_Relative_Peak', 'NF_Sizer_Transit_Time_nsec', 'Seconds', 'Size_um', 'Xe1_FluorPeak', 'Xe2_FluorPeak')
